...
const Users = () => {
    ...
    // ২. অ্যাডমিন বানানোর সময় চাবি পাঠানো হচ্ছে
    ...
    // ৩. ডিলিট করার সময় চাবি পাঠানো হচ্ছে
    ...
    return (
        <>
            <style>{`
                .us-container { background: #13131e; border: 1px solid rgba(255, 255, 255, 0.06); border-radius: 14px; padding: 24px; margin-top: 10px; }
            ...
            <div className="us-container">
                <div className="us-header">
                    <div>
                        <div className="us-title">Manage Users</div>
                        <div className="us-subtitle">Total {users.length} users registered</div>
                    </div>
                </div>
                        ...
                        <tbody>
                            {users.map((user) => (
                                <tr key={user._id} className="us-tr">
                                    ...
                                    <td className="us-td">
                                        <span className={`us-role-badge ${user.role === 'admin' ? 'role-admin' : 'role-user'}`}>
